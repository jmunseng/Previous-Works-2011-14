...
(students_NUMBER SMALLINT NOT NULL,
 SECTION_ID SMALLINT NOT NULL,
 GRADE CHAR(1),
 CONSTRAINT stno_secid PRIMARY KEY (students_NUMBER, SECTION_ID));

create table section
(SECTION_ID SMALLINT PRIMARY KEY NOT NULL,
 courses_NUM NVARCHAR2(8),
...
;
create table prereq
(courses_NUMBER NVARCHAR2(8),
 PREREQ NVARCHAR2(8),
 CONSTRAINT couno_pre PRIMARY KEY(courses_NUMBER, PREREQ));

create table courses
(courses_NAME NVARCHAR2(20),
 courses_NUMBER NVARCHAR2(8) PRIMARY KEY NOT NULL,
...
insert into courses values('ACCOUNTING I','ACCT2020',3,'ACCT');
insert into courses values('ACCOUNTING II ','ACCT2220',3,'ACCT');
insert into courses values('MANAGERIAL FINANCE','ACCT3333',3,'ACCT');
insert into courses values('ACCOUNTING INFO SYST','ACCT3464',3,'ACCT');
insert into courses values('INTRO TO COMPUTER SC','COSC1310',4,'COSC');
insert into courses values('TURBO PASCAL','COSC2025',3,'COSC');
insert into courses values('ADVANCED COBOL','COSC2303',3,'COSC');
insert into courses values('DATA STRUCTURES ','COSC3320',4,'COSC');
insert into courses values('DATABASE','COSC3380',3,'COSC');
insert into courses values('OPERATIONS RESEARCH ','COSC3701',3,'COSC');
insert into courses values('ADVANCED ASSEMBLER','COSC4301',3,'COSC');
insert into courses values('SYSTEM PROJECT','COSC4309',3,'COSC');
insert into courses values('ADA - INTRODUCTION','COSC5234',4,'COSC');
insert into courses values('NETWORKS','COSC5920',3,'COSC');
insert into courses values('ENGLISH COMP I','ENGL1010',3,'ENGL');
insert into courses values('ENGLISH COMP II ','ENGL1011',3,'ENGL');
insert into courses values('WRITING FOR NON MAJO','ENGL3520',2,'ENGL');
insert into courses values('ALGEBRA ','MATH2333',3,'MATH');
insert into courses values('DISCRETE MATHEMATICS','MATH2410',3,'MATH');
insert into courses values('CALCULUS 1','MATH1501',4,'MATH');
insert into courses values('AMERICAN CONSTITUTIO','POLY1201',1,'POLY');
insert into courses values('INTRO TO POLITICAL S','POLY2001',3,'POLY');
insert into courses values('AMERICAN GOVERNMENT ','POLY2103',2,'POLY');
insert into courses values('SOCIALISM AND COMMUN','POLY4103',4,'POLY');
insert into courses values('POLITICS OF CUBA','POLY5501',4,'POLY');
insert into courses values('TECHNICAL WRITING ','ENGL3402',2,'ENGL');
insert into courses values('FUND. TECH. WRITING ','ENGL3401',3,'ENGL');
insert into courses values('INTRO TO CHEMISTRY','CHEM2001',3,'CHEM');
insert into courses values('ORGANIC CHEMISTRY ','CHEM3001',3,'CHEM');
insert into courses values('CALCULUS 2','MATH1502',3,'MATH');
insert into courses values('CALCULUS 3','MATH1503',3,'MATH');
insert into courses values('MATH ANALYSIS','MATH5501',3,'MATH');
...
insert into students values(2,'Lineas','ENGL','1','15-APR-80');
insert into students values(3,'Mary','COSC','4','16-JUL-78');
insert into students values(8,'Brenda','COSC','2','13-AUG-77');
insert into students values(10,'Richard','ENGL','1','13-MAY-80');
insert into students values(13,'Kelly','MATH','4','12-AUG-80');
insert into students values(14,'Lujack','COSC','1','12-FEB-77'); 
insert into students values(15,'Reva','MATH','2','10-JUN-80'); 
insert into students values(17,'Elainie','COSC','1','12-AUG-76');
insert into students values(19,'Harley','POLY','2','16-APR-81'); 
insert into students values(20,'Donald','ACCT','4','15-OCT-77'); 
insert into students values(24,'Chris','ACCT','4','12-FEB-78');
insert into students values(34,'Lynette','POLY','1','16-JUL-81');
insert into students values(49,'Susan','ENGL','3','11-MAR-80');
insert into students values(62,'Monica','MATH','3','14-OCT-80'); 
insert into students values(70,'Bill','POLY',null,'14-OCT-80');
insert into students values(121,'Hillary','COSC','1','16-JUL-77'); 
insert into students values(122,'Phoebe','ENGL','3','15-APR-80');
insert into students values(123,'Holly','POLY','4','15-JAN-81'); 
insert into students values(125,'Sadie','MATH','2','12-AUG-80'); 
insert into students values(126,'Jessica','POLY','2','16-JUL-81'); 
insert into students values(127,'Steve','ENGL','1','11-MAR-80'); 
insert into students values(128,'Brad','COSC','1','10-SEP-77');
insert into students values(129,'Cedric','ENGL','2','15-APR-80');
insert into students values(130,'Alan','COSC','2','16-JUL-77');
insert into students values(131,'Rachel','ENGL','3','15-APR-80');
insert into students values(132,'George','POLY','1','16-APR-81');
insert into students values(142,'Jerry','COSC','4','12-MAR-78'); 
insert into students values(143,'Cramer','ENGL','3','15-APR-80');
insert into students values(144,'Fraiser','POLY','1','16-JUL-81'); 
insert into students values(145,'Harrison','ACCT','4','12-FEB-77');
insert into students values(146,'Francis','ACCT','4','11-JUN-77'); 
insert into students values(147,'Smithly','ENGL','2','13-MAY-80'); 
insert into students values(148,'Sebastian','ACCT','2','14-OCT-76'); 
insert into students values(31,'Jake','COSC','4','12-FEB-78'); 
insert into students values(151,'Losmith','CHEM','3','15-JAN-81'); 
insert into students values(153,'Genevieve','UNKN',null,'15-OCT-79');
insert into students values(155,'Lindsay','UNKN','1','15-OCT-79'); 
insert into students values(157,'Stephanie','MATH',null,'16-APR-81');
insert into students values(158,'Thornton',null,null,'15-OCT-79'); 
insert into students values(163,'Lionel',null,null,'15-OCT-79'); 
insert into students values(161,'Benny','CHEM','4','10-JUN-80'); 
insert into students values(160,'Gus','ART ','3','15-OCT-78'); 
insert into students values(5,'Zelda','COSC',null,'12-FEB-78');
insert into students values(7,'Mario','MATH',null,'12-AUG-80');
insert into students values(9,'Romona','ENGL',null,'15-APR-80'); 
insert into students values(6,'Ken','POLY',null,'15-JUL-80');
insert into students values(88,'Smith',null,null,'15-OCT-79'); 
insert into students values(191,'Jake','MATH','2','10-JUN-80'); 
